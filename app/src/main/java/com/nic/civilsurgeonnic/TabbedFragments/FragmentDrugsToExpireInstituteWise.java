...
public class FragmentDrugsToExpireInstituteWise extends Fragment implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rv1.setOnItemClickListner(new RVAdapterInstituteDetail.OnItemClickListener() {
            @Override
            public void onItemClick(String Id) {
                StaticInstituteCode.set(Id);

                fragmentTransaction = getFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.main_container, new FragmentDrugsToExpire());
