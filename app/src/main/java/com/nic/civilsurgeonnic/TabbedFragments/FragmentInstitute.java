...
public class FragmentInstitute extends Fragment implements SwipeRefreshLayout.OnRefreshListener  {
...
rv1.setOnItemClickListner(new RVAdapterInstituteDetail.OnItemClickListener() {
    ...
    public void onItemClick(String Id) {
        ...
        fragmentTransaction.replace(R.id.main_container, new FragmentInstituteWiseMedicine());
