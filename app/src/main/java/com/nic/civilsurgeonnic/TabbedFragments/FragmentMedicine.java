...
import com.nic.civilsurgeonnic.DistrictWiseStock;
...
public class FragmentMedicine extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
/*        mFragmentManager = getSupportFragmentManager();
        ...
        rv1.setOnItemClickListner(new RVAdapterDrugDetail.OnItemClickListener() {
            ...
            public void onItemClick(String Id) {
                ...
                fragmentTransaction.replace(R.id.main_container, new DistrictWiseStock());
