...
import utils.RVAdapterNotPerformingInstitutes;


public class FragmentNonPerformingInstitutes extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    RecyclerView lvItems;
    DbHandler dbh;
    RVAdapterNotPerformingInstitutes rv1;
    Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list=new ArrayList<>();
        rv1=new RVAdapterNotPerformingInstitutes(list);
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                if(newText.equals("")) {
                    ...
                    rv1 = new RVAdapterNotPerformingInstitutes(dbh.get_Institute_not_performing(null));
                    lvItems.setAdapter(rv1);
                    rv1.notifyDataSetChanged();
                }
                else {
                    rv1 = new RVAdapterNotPerformingInstitutes(dbh.get_Institute_not_performing(newText));
                    lvItems.setAdapter(rv1);
                    rv1.notifyDataSetChanged();
                }
    ...
    private class LoadData extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            return dbh.Load_InstitutesNotPerforming_table(getActivity());
